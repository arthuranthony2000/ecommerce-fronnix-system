          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                <a href="<?= Url::toRoute(['site/detalhe','idProduto'=>$produto->idProduto,'idCategoria'=>$produto->idCategoria]) ?>">
                  <img class="card-img-top" style="max-height: 300px; overflow: hidden;" src="<?= $produto['imagem'] ?>" alt=""></a>
                <div class="card-body" >
                  <h4 class="card-title">
                    <a href="<?= Url::toRoute(['site/detalhe','idProduto'=>$produto->idProduto,'idCategoria'=>$produto->idCategoria]) ?>"><?= $produto['nomeProduto'] ?></a>
                  </h4>
