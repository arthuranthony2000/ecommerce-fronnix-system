          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4" >
              <div class="card h-100">
                ...
                <div class="card-footer">
                  ...
                  <?= Html::a(Yii::t('app','Criar produto'), ['gerencia/create'],['class' => 'btn btn-primary']) ?>         
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4" >
              <div class="card h-100">
                ...
                <div class="card-footer">                  
                  <?= Html::a(Yii::t('app','Gerenciar Vendas'), ['gerencia/gerencia'],['class' => 'btn btn-success']) ?>         
                </div>
              </div>
            </div>
...
?>
            ...
            <div class="col-lg-4 col-md-6 mb-4" >
              <div class="card h-100">
                <a href="<?= Url::toRoute(['gerencia/detalhe','idProduto'=>$produto->idProduto]) ?>">
                  <img class="card-img-top" style="max-height: 300px; overflow: hidden;" src="<?= $produto['imagem'] ?>" alt=""></a>
                <div class="card-body" >
                  <h4 class="card-title">
                    <a href="<?= Url::toRoute(['gerencia/detalhe','idProduto'=>$produto->idProduto]) ?>"><?= $produto['nomeProduto'] ?></a>
                  </h4>
                  <h5><?= $produto['valorProduto'] ?> R$ </h5>

                  <h6 style="overflow:scroll;height:100px;width:100%;overflow:auto"><?= $produto['descricaoProduto'] ?></h6>
                </div>
                <div class="card-footer">
                  
                    <?= Html::a(Yii::t('app','Atualizar'), ['gerencia/update','id'=>$produto->idProduto],['class' => 'btn btn-success']) ?>
                    <?= Html::a(Yii::t('app','Deletar'), ['gerencia/remove','idProduto'=>$produto->idProduto],['class' => 'btn btn-danger']) ?>
                    <br/>
                    <br/> 
                    <h6>Pedidos: <?= $j ?></h6>              
                </div>
